...
export default function UserInfoModal({ isOpen, onClose, user: initialUser }: UserInfoModalProps) {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      if (isOpen && initialUser.id) {
        setLoading(true)
        try {
          const response = await fetch(`/admin/users/${initialUser.id}`)
