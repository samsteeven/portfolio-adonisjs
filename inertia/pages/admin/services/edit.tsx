...
export default function AdminServiceEdit({ service }: Props) {
        ...
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600">Modifiez les détails de votre service</p>
            </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          type="number"
                          value={
                            data.price === '' || isNaN(Number(data.price)) ? '' : String(data.price)
                          }
                      ...
                      {processing || uploading ? (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm sm:text-base">
                            {uploading ? 'Upload en cours...' : 'Mise à jour en cours...'}
                          </span>
                        </div>
                      ) : (
                        <div className="flex items-center gap-2">
                          <Save className="h-4 w-4" />
                          <span className="text-sm sm:text-base">Mettre à jour</span>
                        </div>
                      )}
                    </Button>
...
AdminServiceEdit.layout = (page: React.ReactNode) => (
  <AdminLayout
    ...
    description="Modification d'un service existant"
    currentPath="/admin/services/edit"
  >
    {page}
  </AdminLayout>
)
