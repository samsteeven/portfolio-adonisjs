...
import { ArrowLeft, Image, Info, Calendar, Clock } from 'lucide-react'
...
export default function EditSkill({ skill, categories }: Props) {
  ...
  const hasNewImage = !!fileInputRef.current?.files?.length
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">"{skill.name}"</p>
              </div>
                    ...
                    <div>
                      ...
                      {categories.length > 0 && (
                        <div className="mb-3">
                          ...
                          <p className="mt-1.5 text-xs text-gray-500">ou modifiez-la ci-dessous</p>
                        </div>
                      )}
                  ...
                  <div className="space-y-3">
                    {imagePreview ? (
                      <div className="relative group">
                        ...
                        {hasNewImage && (
                          <div className="absolute bottom-3 left-3 bg-blue-600 text-white text-xs px-2.5 py-1 rounded-md backdrop-blur-sm shadow-lg">
              ...
              <div className="space-y-6">
                ...
                <Card className="p-4 sm:p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 text-xs">
                          {new Date(skill.createdAt).toLocaleTimeString('fr-FR', {
                            hour: '2-digit',
                            minute: '2-digit',
                          })}
                        </p>
                    ...
                    {skill.updatedAt && (
                      <div className="flex items-start gap-3 text-sm pt-3 border-t border-gray-100">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-xs">
                            {new Date(skill.updatedAt).toLocaleTimeString('fr-FR', {
                              hour: '2-digit',
                              minute: '2-digit',
                            })}
                          </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <Link href={'/admin/skills'}>
                      <Button
                        type="button"
                        variant="outline"
                        className="w-full border-none hover:bg-gray-50"
                      >
                        Annuler
                      </Button>
                    </Link>
