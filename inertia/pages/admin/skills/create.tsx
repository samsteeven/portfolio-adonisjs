...
export default function CreateSkill({ categories }: CreateSkillProps) {
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">Ajoutez une nouvelle compétence à votre portfolio</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                errors.imagePath ? 'border-red-300' : 'border-gray-300'
              }`}
              placeholder="Chemin vers l'image de la compétence"
            />
            {errors.imagePath && (
          ...
          <div>
            <label className="flex items-center gap-2">
              ...
              />
              <span className="text-sm font-medium text-gray-700">Compétence active</span>
            </label>
          </div>
...
CreateSkill.layout = (page: React.ReactNode) => (
  <AdminLayout
    ...
    description="Ajouter une nouvelle compétence"
